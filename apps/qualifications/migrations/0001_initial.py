    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(choices=[('', 'Select a Level'), ('level-1', 'Level 1'), ('level-2', 'Level 2'), ('level-3', 'Level 3'), ('level-4', 'Level 4'), ('level-5', 'Level 5'), ('level-6', 'Level 6'), ('level-7', 'Level 7')], max_length=80, unique=True)),
