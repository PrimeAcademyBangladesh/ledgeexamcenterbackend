...
EMAIL_HOST_PASSWORD = os.environ.get('EMAIL_HOST_PASSWORD', 're_AUZE1YX4_48Gde69xjeckDTRbExh95D2g')
EMAIL_USE_SSL = True
EMAIL_USE_TLS = False
DEFAULT_FROM_EMAIL = os.environ.get('DEFAULT_FROM_EMAIL', 'no-reply@leadedgeltd.org')
